...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <aside
      className={`
        fixed inset-y-0 left-0 z-30 flex flex-col w-64 bg-blue-800 text-white
    ...
    >
      ...
      <div className="px-4 py-4 border-t border-blue-700">
        <button
          ...
          className="w-full flex items-center gap-3 mb-3 p-2 rounded-lg hover:bg-blue-700 transition-colors text-left"
        >
        ...
        <button
          onClick={signOut}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-blue-200 hover:bg-blue-700 hover:text-white transition-colors"
        >
          <LogOut size={16} />
          Sair
        </button>
