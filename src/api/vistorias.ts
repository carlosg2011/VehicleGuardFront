...
import type { Vistoria, VistoriaFoto, PagedResult, StatusVistoria } from '../types';
...
export const upsertVistoriaFoto = (
  id: number,
  data: { slot: string; url: string; verdict?: string | null }
) => api.put<VistoriaFoto>(`/vistoria/${id}/fotos`, data).then((r) => r.data);
